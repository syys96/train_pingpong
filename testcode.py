...
def main(log,winner,reason):
    ...
    while True:
        ...
        if over and tick >= next_tick + 1800:
            ...
            if winner == 'East':
                screen.blit(image, (
                table[1][0] + 100 - 20 - 40, table[1][1] - 50 - 20))  # (table[0][0] - 24 - 100 - 20, table[0][1] - 50)
            elif winner == 'West':
                screen.blit(image, (
                table[0][0] - 24 - 100 - 20 - 40, table[0][1] - 50 - 20))  # (table[1][0] + 100 - 20, table[1][1] - 50)
